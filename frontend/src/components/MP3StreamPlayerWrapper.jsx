...
export default function MP3StreamPlayerWrapper({ text, voice }) {
  ...
  useEffect(() => {
    ...
    console.log("MP3StreamPlayerWrapper: Setting up audio for new text");
    ...
    console.log("MP3StreamPlayerWrapper: Streaming from URL:", url);
    ...
    return () => {
      console.log("MP3StreamPlayerWrapper: Cleaning up");
      if (playerRef.current) {
